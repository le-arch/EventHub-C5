...
type ListOrganizerEventRow struct {
	ID             uuid.UUID                  `json:"id"`
	OrganizerID    uuid.UUID                  `json:"organizer_id"`
	Title          string                     `json:"title"`
	Slug           string                     `json:"slug"`
...
func (q *Queries) ListOrganizerEvent(ctx context.Context, arg ListOrganizerEventParams) (ListOrganizerEventRow, error) {
	row := q.db.QueryRow(ctx, listOrganizerEvent, arg.ID, arg.OrganizerID)
	var i ListOrganizerEventRow
	err := row.Scan(
		&i.ID,
		&i.OrganizerID,
		&i.Title,
