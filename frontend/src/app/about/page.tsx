...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 antialiased selection:bg-purple-500/10 overflow-hidden relative">
      ...
      {/* Hero Header Section */}
      <div className="relative border-b border-slate-200/80 bg-gradient-to-b from-purple-50/60 via-indigo-50/40 to-transparent pt-12 pb-24 lg:pt-16 lg:pb-32 z-10">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="text-center space-y-6">
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-2xl mx-auto font-medium leading-relaxed">
      ...
      <section className="container mx-auto px-4 py-24 relative z-10 max-w-5xl">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 bg-white border border-slate-200 shadow-xl shadow-slate-200/50 rounded-3xl p-6 sm:p-8 space-y-4">
            <div className="flex gap-4 items-start">
              <CheckCircle2 className="h-5 w-5 text-purple-600 shrink-0 mt-1" />
              <p className="text-slate-600 text-sm md:text-base">
                <strong className="text-slate-900 block mb-0.5">The Legacy Problem:</strong> Event promoters previously navigated disjointed WhatsApp groups, fragmented Excel spreadsheets, and physical paper rosters.
              </p>
            </div>
            <div className="flex gap-4 items-start">
              <CheckCircle2 className="h-5 w-5 text-indigo-600 shrink-0 mt-1" />
              <p className="text-slate-600 text-sm md:text-base">
                <strong className="text-slate-900 block mb-0.5">Payment Challenges:</strong> Ticket distribution fell short without seamless Mobile Money automation frameworks, extending waiting lines at active gates.
              </p>
            </div>
            <div className="flex gap-4 items-start">
              <CheckCircle2 className="h-5 w-5 text-blue-600 shrink-0 mt-1" />
              <p className="text-slate-600 text-sm md:text-base">
                <strong className="text-slate-900 block mb-0.5">Our Solution:</strong> An intuitive SaaS platform consolidating registration, analytical tracking, live validation matrices, and streamlined checkout systems.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {stats.map((stat, index) => {
              ...
              return (
                <div key={index} className="bg-slate-50 border border-slate-200 rounded-2xl p-6 text-center shadow-sm transition-transform duration-300 hover:-translate-y-1">
                  ...
                  <h3 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight">{stat.value}</h3>
      ...
      <section className="container mx-auto px-4 py-24 relative z-10 max-w-5xl">
        <div className="text-center space-y-2 mb-16">
          ...
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-slate-900">How We Shape Tomorrow</h2>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          {values.map((item, index) => {
            const Icon = item.icon
            return (
              <Card key={index} className="bg-white border-slate-200 shadow-xl shadow-slate-200/40 group transition-all duration-300 hover:-translate-y-1 hover:border-purple-500/40">
                <CardHeader className="pb-3">
                  ...
                  <CardTitle className="text-lg font-bold text-slate-900 tracking-tight">{item.title}</CardTitle>
                </CardHeader>
                <CardContent>
      ...
      <section className="bg-slate-100/60 border-t border-slate-200 py-24 relative z-10">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center space-y-3 mb-16">
            <span className="text-xs font-bold uppercase tracking-widest text-purple-600">Architects of EventHub</span>
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">Meet the Team</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {teamMembers.map((member, index) => (
              <Card key={index} className="bg-white border-slate-200 text-center group transition-all duration-300 hover:-translate-y-1 hover:border-purple-500/40 overflow-hidden relative shadow-xl shadow-slate-200/50">
                ...
                <CardHeader className="pb-3 pt-8">
                  ...
                  <CardTitle className="text-lg font-bold text-slate-900 tracking-tight group-hover:text-purple-600 transition-colors">{member.name}</CardTitle>
                ...
                <CardContent className="pb-8">
                  <p className="text-xs md:text-sm text-slate-600 leading-relaxed px-2">{member.bio}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <section className="relative overflow-hidden py-24 border-t border-slate-200 bg-slate-900 text-white">
      ...
      <section className="container mx-auto px-4 py-16 relative z-10 max-w-4xl border-t border-slate-200">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
          <div className="space-y-1">
            <div className="w-9 h-9 bg-white border border-slate-200 rounded-xl flex items-center justify-center mx-auto shadow-sm">
              <Mail className="h-4 w-4 text-purple-600" />
            </div>
            <h3 className="font-semibold text-xs text-slate-500 uppercase tracking-wider pt-1">Email</h3>
            <p className="text-xs text-slate-700 font-medium">support@eventhub.com</p>
          </div>
          <div className="space-y-1">
            <div className="w-9 h-9 bg-white border border-slate-200 rounded-xl flex items-center justify-center mx-auto shadow-sm">
              <Phone className="h-4 w-4 text-indigo-600" />
            </div>
            <h3 className="font-semibold text-xs text-slate-500 uppercase tracking-wider pt-1">WhatsApp</h3>
            <p className="text-xs text-slate-700 font-medium">+237 670 142 124</p>
          </div>
          <div className="space-y-1">
            <div className="w-9 h-9 bg-white border border-slate-200 rounded-xl flex items-center justify-center mx-auto shadow-sm">
              <MapPin className="h-4 w-4 text-blue-600" />
            </div>
            <h3 className="font-semibold text-xs text-slate-500 uppercase tracking-wider pt-1">Location</h3>
            <p className="text-xs text-slate-700 font-medium">Buea, Cameroon</p>
          </div>
        </div>
      </section>
    </div>
