...
export default function TicketPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-muted/50 flex items-center justify-center p-4">
        <Card className="glass max-w-md w-full border-border/80 rounded-2xl">
  ...
  return (
    <div className="min-h-screen bg-muted/50 text-foreground antialiased py-12 px-4 relative overflow-hidden">
      ...
      <div className="max-w-md mx-auto relative z-10 space-y-6">
        ...
        <Card className="glass border-border/80 rounded-2xl overflow-hidden animate-slide-up">
          ...
          <CardContent className="pt-8 pb-6 text-center bg-muted/50/50">
          ...
          <div className="relative flex items-center justify-between px-0 bg-muted/50/50">
            <div className="w-3 h-6 bg-muted/50 rounded-r-full border-r border-t border-b border-border/80 -ml-[1px]" />
            <Separator className="border-dashed border-border bg-transparent flex-1 mx-2" />
            <div className="w-3 h-6 bg-muted/50 rounded-l-full border-l border-t border-b border-border/80 -mr-[1px]" />
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-start gap-2.5 text-sm">
                ...
                <div className="space-y-0.5">
                  <span className="text-[10px] uppercase font-bold tracking-wider text-muted-foreground block">Date</span>
              ...
              <div className="flex items-start gap-2.5 text-sm">
                ...
                <div className="space-y-0.5">
                  <span className="text-[10px] uppercase font-bold tracking-wider text-muted-foreground block">Venue</span>
          ...
          <CardContent className="py-5 px-6 space-y-3 bg-muted/50/20 text-sm font-medium text-muted-foreground">
          ...
          <CardContent className="py-4 text-center bg-muted/50/50 space-y-1">
        ...
        <div className="space-y-2.5 pt-2">
          ...
          <Button 
            variant="outline" 
            onClick={shareTicket} 
            className="w-full bg-card text-foreground hover:bg-muted/50 border-border h-11 rounded-xl font-semibold transition-all flex items-center justify-center gap-2"
          >
          ...
          <Button 
            variant="ghost" 
            onClick={() => router.push('/')} 
            className="w-full text-muted-foreground hover:text-muted-foreground hover:bg-muted/30/50 h-10 rounded-xl font-medium transition-all flex items-center justify-center gap-2"
          >
        ...
        <div className="pt-4 border-t border-border/60 grid grid-cols-3 gap-3 text-center">
          <div className="space-y-1.5 p-2 rounded-xl bg-muted/30/40 border border-border/30">
            <div className="w-6 h-6 rounded-lg bg-slate-900/5 flex items-center justify-center text-muted-foreground mx-auto">
              <Download className="h-3 w-3" />
            </div>
            <p className="text-[10px] text-muted-foreground font-bold leading-tight">Commit to Storage</p>
          </div>
          <div className="space-y-1.5 p-2 rounded-xl bg-muted/30/40 border border-border/30">
            <div className="w-6 h-6 rounded-lg bg-slate-900/5 flex items-center justify-center text-muted-foreground mx-auto">
              <Layers className="h-3 w-3" />
            </div>
            <p className="text-[10px] text-muted-foreground font-bold leading-tight">Present QR Token</p>
          </div>
          <div className="space-y-1.5 p-2 rounded-xl bg-muted/30/40 border border-border/30">
            <div className="w-6 h-6 rounded-lg bg-slate-900/5 flex items-center justify-center text-muted-foreground mx-auto">
              <ShieldCheck className="h-3 w-3" />
            </div>
            <p className="text-[10px] text-muted-foreground font-bold leading-tight">Single Clearance</p>
          </div>
        </div>
