...
const CAMEROON_CITIES = [
  ...
  'Bertoua', 'Loum', 'Kribi', 'Mbalmayo', 'Foumban',
]
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                {basicForm.formState.errors.venueName && (
                  <p className="text-sm text-red-500 mt-1">
                    {basicForm.formState.errors.venueName.message}
                  </p>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  {basicForm.formState.errors.startDate && (
                    <p className="text-sm text-red-500 mt-1">
                      {basicForm.formState.errors.startDate.message}
                    </p>
                  )}
                </div>
                <div>
                  ...
                  {basicForm.formState.errors.startTime && (
                    <p className="text-sm text-red-500 mt-1">
                      {basicForm.formState.errors.startTime.message}
                    </p>
                  )}
                </div>
              </div>
            ...
            <CardContent className="space-y-4">
              ...
              {ticketForm.formState.errors.ticketTypes && (
                <p className="text-sm text-red-500">
                  {ticketForm.formState.errors.ticketTypes.message}
                </p>
              )}
            </CardContent>
            <CardFooter className="flex justify-between">
